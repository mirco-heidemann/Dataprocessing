...
## relative pfade
# pth_port <- ("I:/Datadrop/") # MHE, GVZ
pth_port <- ("/Users/mirco/Documents/02 First Drafts/") # Mircos MacBook
...
```{r}
input_csv <- paste0(pth_port, "Rubin_Objektschaeden_2021_per_20211215.csv")
