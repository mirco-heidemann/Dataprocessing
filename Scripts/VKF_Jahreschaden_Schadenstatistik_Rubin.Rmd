...
- Export aus GemDat/Rubin: Objektschäden --> Auswertung Objektschäden: Schadendatum und Erfassungsdatum (gleich wie Schadendatum) eingeben
...
```{r}
input_csv <- paste0(pth_port, "Objektschaeden_2019_2021.csv")
